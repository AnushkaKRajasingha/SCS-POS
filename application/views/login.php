...
<body>
	<div id="logo" align="center"><img src="<?php echo base_url();?>/images/scslogo.jpg" style="width:150px;heigth:auto;"></div>



	<div id="login">
<h1>SCS Point Of Sale <?php echo $this->config->item('application_version'); ?></h1>
