<div id="receipt_wrapper">
	...
	<table id="receipt_items">
		<tr>
			<th style="width:40%;max-width: 20%;"><?php echo $this->lang->line('sales_description_abbrv'); ?></th>
		...
		?>
			<tr>
				<td style="max-width: 20%;word-wrap: break-word;"><?php echo ucfirst($item['name']); ?></td>
